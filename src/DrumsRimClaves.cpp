...
DrumsRimClaves::DrumsRimClaves() : Module(NUM_PARAMS,NUM_INPUTS,NUM_OUTPUTS,9)
{
	// disarm
...
{
DrumsRimClavesWidget(DrumsRimClaves *module) : ModuleWidget(module)
{
	setPanel(SVG::load(assetPlugin(plugin, "res/DrumsRimClaves.svg")));
...
Model *modelRimClaves = Model::create<DrumsRimClaves,DrumsRimClavesWidget>("Autodafe-DrumKit", "Drums - RimClaves", "Rim/Claves",DRUM_TAG);
