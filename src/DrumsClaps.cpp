...
DrumsClaps::DrumsClaps() : Module(NUM_PARAMS,NUM_INPUTS,NUM_OUTPUTS,9)
{
	// disarm
...
{
DrumsClapsWidget(DrumsClaps *module) : ModuleWidget(module)
{
...
Model *modelClaps = Model::create<DrumsClaps,DrumsClapsWidget>("Autodafe-DrumKit", "Drums - Claps", "Claps",DRUM_TAG);
